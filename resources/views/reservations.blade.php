    ...
    'subtitle' => 'Manage all guest reservations and room assignments'
        ...
        <div class="px-6 py-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow p-6 border-2 border-blue-300 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500 mt-1">All reservations in system</p>
                        </div>
                        <div class="flex items-center space-x-2">
                            <p class="text-2xl font-bold text-blue-600">{{ $reservations->total() }}</p>
                ...
                <!-- Pending Card -->
                <div class="bg-white rounded-xl shadow p-6 border-2 border-yellow-300 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                ...
                <div class="bg-white rounded-xl shadow p-6 border-2 border-green-300 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Reservations confirmed</p>
                        </div>
                        <div class="flex items-center space-x-2">
                ...
                <!-- Active Stays Card -->
                <div class="bg-white rounded-xl shadow p-6 border-2 border-purple-300 hover:shadow-lg transition-shadow">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            <p class="text-sm font-medium text-gray-600">Active Stays</p>
                            <p class="text-xs text-gray-500 mt-1">Currently checked-in</p>
                        </div>
                        <div class="flex items-center space-x-2">
