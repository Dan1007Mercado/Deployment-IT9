                        ...
                        <div id="step-1" class="step-content">
                            ...
                            <form id="guest-form" class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="first_name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200" required>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium mb-1">Last Name *</label>
                                    <input type="text" name="last_name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200" required>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="contact_number" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200" required>
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium mb-1">Booking Source</label>
                                    <select name="booking_source" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200" required>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="special_requests" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-blue-200" placeholder="Any special requirements..."></textarea>
                                </div>
                            </form>
                            <div class="flex justify-end mt-8">
                                <button onclick="nextStep(2)" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Next: Select Dates</button>
                            </div>
                        </div>
...
<div id="room-selection-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-center">
                <h3 class="text-xl font-semibold">Select Rooms</h3>
                <button onclick="closeRoomModal()" class="text-gray-400 hover:text-gray-600 text-2xl">&times;</button>
            </div>
        </div>
        <div class="p-6 overflow-y-auto max-h-[60vh]">
            <div id="modal-available-rooms" class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="p-6 border-t border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <span id="modal-selected-count" class="font-semibold">0 rooms</span>
                </div>
                <div class="flex space-x-3">
                    <button onclick="closeRoomModal()" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">Cancel</button>
                    <button onclick="confirmRoomSelection()" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Add to Reservation</button>
                </div>
            </div>
        </div>
    </div>
...
function updateConfirmation() {
    ...
    const bookingSource = document.querySelector('[name="booking_source"]').value;
