...
<aside class="bg-[#14416b] text-white w-64 flex flex-col justify-between py-6 px-4">
    <div>
        ...
        <nav>
            <ul class="space-y-2">
                ...
                <li>
                    <a href="/reports" class="flex items-center px-3 py-2 rounded {{ Request::is('reports') ? 'bg-[#1e3a5f] font-semibold' : 'hover:bg-[#1e3a5f]' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li>
                    <a href="/settings" class="flex items-center px-3 py-2 rounded {{ Request::is('settings') ? 'bg-[#1e3a5f] font-semibold' : 'hover:bg-[#1e3a5f]' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex items-center space-x-3 bg-[#0e2a47] p-3 rounded">
        <span class="bg-yellow-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold text-lg">A</span>
        <div>
            <div class="font-semibold">Admin User</div>
            <div class="text-xs text-gray-200">admin@hotel.com</div>
        </div>
    </div>
</aside>
